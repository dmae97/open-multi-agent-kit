...
const allowedScenarios = new Set(["no-kimi-smoke", "evidence-block", "fallback-route", "dag-dependent-block", "replay-inspect", "graph-audit", "example-generation", "doctor-provider", "native-safety", "contract-version-smoke", "regression-proof-matrix", "release-truthfulness"]);
