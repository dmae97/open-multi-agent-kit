...
| --- | --- | --- | --- |
| Package version | `0.80.1` | `package.json`, `package-lock.json` | npm/package source version. |
...
`0.80.1` is the package source version for the `v1.2` runtime contract family.
...
- Use `0.80.1` when referring to the current package source version.
