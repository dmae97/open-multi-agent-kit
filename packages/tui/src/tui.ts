...
export class TUI extends Container {
	...
	private showHardwareCursor = process.env.OMK_HARDWARE_CURSOR === "1" || process.env.PI_HARDWARE_CURSOR === "1";
	private clearOnShrink = process.env.OMK_CLEAR_ON_SHRINK === "1" || process.env.PI_CLEAR_ON_SHRINK === "1"; // Clear empty rows when content shrinks (default: off)
	...
	private doRender(): void {
		...
		const debugRedraw = process.env.OMK_DEBUG_REDRAW === "1" || process.env.PI_DEBUG_REDRAW === "1";
		...
		if (process.env.OMK_TUI_DEBUG === "1" || process.env.PI_TUI_DEBUG === "1") {
