...
export const classify_memory = classifyMemory;
export const classify_batch = classifyBatch;
export const get_type_priority = getTypePriority;
export const should_consolidate = shouldConsolidate;
export const get_decay_rate = getDecayRate;
