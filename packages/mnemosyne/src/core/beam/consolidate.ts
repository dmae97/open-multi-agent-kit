...
const SLEEP_BATCH_SIZE = envInt("MNEMOSYNE_SLEEP_BATCH", 5000);
const TIER2_DAYS = envInt("MNEMOSYNE_TIER2_DAYS", 30);
const TIER3_DAYS = envInt("MNEMOSYNE_TIER3_DAYS", 180);
const DEGRADE_BATCH_SIZE = envInt("MNEMOSYNE_DEGRADE_BATCH", 100);
const TIER3_MAX_CHARS = envInt("MNEMOSYNE_TIER3_MAX_CHARS", 300);
