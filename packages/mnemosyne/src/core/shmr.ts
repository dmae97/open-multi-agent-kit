...
export const SHMR_SIMILARITY_THRESHOLD = Number.parseFloat(process.env.MNEMOSYNE_SHMR_SIMILARITY_THRESHOLD ?? "0.70");
export const SHMR_HARMONY_THRESHOLD = Number.parseFloat(process.env.MNEMOSYNE_SHMR_HARMONY_THRESHOLD ?? "0.60");
export const SHMR_MIN_CLUSTER_SIZE = Number.parseInt(process.env.MNEMOSYNE_SHMR_MIN_CLUSTER_SIZE ?? "2", 10);
