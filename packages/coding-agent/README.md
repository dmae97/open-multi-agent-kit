<p align="center">
  <img src="https://raw.githubusercontent.com/dmae97/open-multi-agent-kit/v0.80.8/readmeasset/omk-control.webp" alt="OMK//CONTROL Night City Ops Console for routing agents, evidence gates, telemetry, MCP scope, and operator control" width="100%" />
</p>
...
<p align="center">
  ...
  <a href="https://github.com/dmae97/open-multi-agent-kit/releases/tag/v0.80.8"><img alt="Release" src="https://img.shields.io/badge/release-v0.80.8-00d7ff?style=flat-square" /></a>
</p>

> New issues and PRs from new contributors are auto-closed by default. Maintainers review auto-closed issues daily. See [CONTRIBUTING.md](https://github.com/dmae97/open-multi-agent-kit/blob/v0.80.8/CONTRIBUTING.md).
...
<p align="center">
  <img src="https://raw.githubusercontent.com/dmae97/open-multi-agent-kit/v0.80.8/readmeasset/omk_tui.png" alt="OMK//CONTROL terminal dashboard — live DAG lanes, provider routing, MCP health, evidence gates, and telemetry in Night City Ops Console style" width="100%" />
</p>
...
GitHub-focused release notes live in [RELEASE_NOTES_v0.80.8.md](https://github.com/dmae97/open-multi-agent-kit/blob/v0.80.8/.github/RELEASE_NOTES_v0.80.8.md). The GitHub release workflow also extracts the canonical release body from [packages/coding-agent/CHANGELOG.md](https://github.com/dmae97/open-multi-agent-kit/blob/v0.80.8/packages/coding-agent/CHANGELOG.md).
...
<p align="center"><img src="https://raw.githubusercontent.com/dmae97/open-multi-agent-kit/v0.80.8/packages/coding-agent/docs/images/interactive-mode.png" alt="Interactive Mode" width="600"></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/dmae97/open-multi-agent-kit/v0.80.8/packages/coding-agent/docs/images/tree-view.png" alt="Tree View" width="600"></p>
...
<p align="center"><img src="https://raw.githubusercontent.com/dmae97/open-multi-agent-kit/v0.80.8/packages/coding-agent/docs/images/doom-extension.png" alt="Doom Extension" width="600"></p>
...
See [CONTRIBUTING.md](https://github.com/dmae97/open-multi-agent-kit/blob/v0.80.8/CONTRIBUTING.md) for guidelines and [docs/development.md](docs/development.md) for setup, forking, and debugging.
