> OMK can create prompt templates. Ask it to build one for your workflow.
...
- Global: `~/.omk/agent/prompts/*.md`
- Project: `.omk/prompts/*.md`
- Packages: `prompts/` directories or `omk.prompts` entries in `package.json`
