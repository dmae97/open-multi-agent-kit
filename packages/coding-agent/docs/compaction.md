...
For TypeScript definitions in your project, inspect `node_modules/@earendil-works/omk-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@earendil-works/omk-coding-agent";
