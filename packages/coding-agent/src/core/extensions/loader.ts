...
// avoiding a circular dependency. Extensions can import from @earendil-works/omk-coding-agent.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@earendil-works/omk-coding-agent": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	_aliases = {
		"@earendil-works/omk-coding-agent": piCodingAgentEntry,
...
function readPiManifest(packageJsonPath: string): PiManifest | null {
	try {
		...
		if (pkg.omk && typeof pkg.omk === "object") {
			return pkg.omk;
		}
