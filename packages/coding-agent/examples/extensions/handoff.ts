...
import type { ExtensionAPI, SessionEntry } from "@earendil-works/omk-coding-agent";
import { BorderedLoader, convertToLlm, serializeConversation } from "@earendil-works/omk-coding-agent";
