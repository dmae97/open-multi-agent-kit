...
import type { ExtensionAPI, ExtensionCommandContext } from "@earendil-works/omk-coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@earendil-works/omk-coding-agent";
