...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.omk/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.omk/skills/inspect/SKILL.md">\nReferences are relative to /project/.omk/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
