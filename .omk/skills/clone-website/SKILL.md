...
pinned-commit: 8dd9cb47dde0d49fec06ee1d69bedd04840f3c95 (short: 8dd9cb4)
upstream-path: .claude/skills/clone-website/SKILL.md
retrieved-from: .omk/goals/011-external-repo-builtins-plan/repos/ai-website-cloner-template (shallow clone, Goal 011 Lane A)
license: MIT, Copyright (c) 2025 JCodesMore -- full text in LICENSE-THIRD-PARTY (this directory)
retrieved: 2026-07-03
sha256(upstream SKILL.md, full file @ pinned commit): 65305b74fc5fa846d716a2edaf17f5f71416ab7bf1ccf23e7cdf40d3c04e3c06
sha256(upstream LICENSE @ pinned commit): cfe9368816ead6d3b0a9e0d851dcab796885c72e7b479cff1c7939debea0826d
goal-evidence: .omk/goals/012-external-repo-builtins-implementation/laneA-clone-website.md (Goal 012 Lane A)

sanitization: the body below (from the "# Clone Website" heading onward) is a byte-identical
  copy of the pinned commit's .claude/skills/clone-website/SKILL.md -- verified by diff against
  a fresh `git show 8dd9cb4:.claude/skills/clone-website/SKILL.md` extraction. No OMK-specific
  content has been interleaved into it. This copy intentionally EXCLUDES an unrelated
  "## DESIGN.md Integration" / npx-based addendum discovered as an uncommitted local edit in a
  separate, non-canonical machine mirror outside this repository (not part of this clone, not
  part of this project's git history, and not used as a source for this file).

do-not-modify: if OMK-specific guidance is ever needed for this skill, add it under a new
  "## OMK Notes" heading appended at the end of this file -- never interleaved into the
  vendored body above this notice.
-->
