...
| ------------------------------- | --------- | ---------------------------------------------- | ------------------------------------------ | ----------- | ------ | -----: |
| `omk-freedomd-control-plane.webp` | yes | v0.80.1 Freedomd README hero | Codex OAuth gpt-image-2 with `omk-control.webp` style reference | `1983x793` | `WEBP` | 1877984 |
| `omk-freedomd-control-plane.svg` | yes | v0.80.1 Freedomd README fallback | deterministic local SVG fallback retained for provenance | `1600x640` | `SVG` | 4415 |
